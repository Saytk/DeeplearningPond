...
# DQN Training Loop with Target Network
def train_dqn_with_target(env, num_episodes=1000, gamma=0.99, alpha=0.001, epsilon=1, epsilon_min=0.1, epsilon_decay=0.995, target_update_freq=100, eval_interval=10):
    ...
    for episode in range(num_episodes):
        ...
        if episode % eval_interval == 0:
            ...
            model_path = save_model(q_network, winrate, folder="saved_models/DQN_with_Target")
...
if __name__ == "__main__":
    ...
    # Train the network
    trained_q_network = train_dqn_with_target(env, num_episodes=1000, eval_interval=10)
